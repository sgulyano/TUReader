...
ranks = {'อาจารย์' : ['อ.'],
         'ศาสตราจารย์ ระดับ 11' : ['ศ.11', 'ศ11'],
         'ศาสตราจารย์ (พิเศษ)' : ["ศาสตราจารย์พิเศษ",'ศ.พิเศษ'],
         'ศาสตราจารย์ (AIT)' : ['ศ.(AIT)'],
         'ศาสตราจารย์ (มจธ.)' : ['ศ.(มจธ.)'],
         'ศาสตราจารย์ (มทม.)' : ['ศ.(มทม.)'],
         'ศาสตราจารย์ (มทส.)' : ['ศ.(มทส.)'],
         'ศาสตราจารย์ (มวล.)' : ['ศ.(มวล.)'],
         'ศาสตราจารย์' : ['ศาสตรจารย์', 'ศาสตราจารย์', 'ศาสตร์ตราจารย์', 'Professor','ศ.*','ศ.','ศ*','ศ'], 
         ...
         'ผู้ช่วยศาสตราจารย์' : ['Assistant Professor','ผศ.','รด.'],
         }
